...
public class Drive extends SubsystemBase {
    ...
    public Drive(
        ...
        PathPlannerLogging.setLogActivePathCallback((activePath) -> {
            ...
            field.getObject("traj").setPoses(activePath.toArray(new Pose2d[0]));
        });
        ...
        public void initSendable(SendableBuilder builder) {
            ...
            builder.addDoubleProperty("Back Right Angle", () -> modules[2].getAngle().getRadians(), null);
            builder.addDoubleProperty("Back Right Velocity", () -> modules[2].getVelocityMetersPerSec(), null);
    
            builder.addDoubleProperty("Robot Angle", () -> getRotation().getRadians(), null);
        }});

        SmartDashboard.putData("Field Display", field);
    }
